...
$.fn.cycle = function(options) {
    return this.each(function() {
        ...
        if (opts.next) $(opts.next).unbind('click.cycle').bind('click.cycle', function(){return advance(els,opts,opts.rev?-1:1);});
        if (opts.prev) $(opts.prev).unbind('click.cycle').bind('click.cycle', function(){return advance(els,opts,opts.rev?1:-1);});
...
function advance(els, opts, val) {
    ...
    if (opts.nextSlide < 0) { opts.nextSlide = els.length - 1; }
